 ...
 */
public class LoginUserRequest extends BasicRequest<User> {
    ...
    private static final String API = Constants.API_SERVER_HOST + "/api/user/login";

    public LoginUserRequest(Context context, BaseApiResponse.OnResponseListener<User> responseListener) {
